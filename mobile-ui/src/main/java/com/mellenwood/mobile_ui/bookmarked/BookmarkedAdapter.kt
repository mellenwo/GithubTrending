...
class BookmarkedAdapter @Inject constructor(): RecyclerView.Adapter<BookmarkedAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_bookmarked_project, parent, false)
    ...
    inner class ViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        init {
            avaterImage = view.findViewById(R.id.image_owner_avatar)
